...
# It should now return a single string of the form City, Country - population xxx, such as Santiago, Chile - 5000000. ✅

# Run test_cities.py again. Make sure test_city_country() fails this time. ✅

# Modify the function so the population parameter is optional. Run test_cities()
...
# you can call your function with the values 'santiago', 'chile', and 'population=50000000'. ✅
